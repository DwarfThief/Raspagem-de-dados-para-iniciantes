# Este script abre MAX_CONCURRENCY, no caso 3, browsers em paraleto, acessa uma url
...
# 
# $ cd Codigo\ Spiders/
# $ python Executando_browsers_paralelos.py 
#
# saída > 
# Link found '127' links in https://pypi.org/project/caqui/
# Link found '600' links in https://pt.wikipedia.org/wiki/Wikip%C3%A9dia:P%C3%A1gina_principal
...
# Link found '4' links in https://www.youtube.com/
# Link found '199' links in https://github.com/DwarfThief/Raspagem-de-dados-para-iniciantes
# Link found '191' links in https://www.vagas.com.br/
# Link found '15' links in https://testautomationu.applitools.com/
# Link found '71' links in http://appium.io/docs/en/2.0/
# Link found '202' links in https://github.com/microsoft/WinAppDriver
# Link found '379' links in https://www.baixelivros.com.br/
# Link found '317' links in https://www.estantevirtual.com.br/
# Time: 24.75 sec
